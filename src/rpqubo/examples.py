...
def alan_problem(
    ...
    *,
    ...
    """Build the Alan MINLPLib problem used in the paper.
    ...
    cardinality_slack_encoding:
        ...
        ``4 * digits_s + 1`` bits. Use this for the paper's bit-growth
    ...
    #     y1 + y2 + y3 + y4 + sc = 3.
    #
    # Two encodings are provided because the paper bit-growth tables and the
    # legacy zoom implementation use different representations for sc.
